...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson = Lesson.objects.create(
            name="Математика", course=self.course, owner=self.user
        )
    ...
    def test_lesson_create(self):
        ...
        data = {"name": "Русский язык", "course": self.course.pk, "owner": self.user.pk}
    ...
    def test_lesson_update(self):
        ...
        data = response.json()
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(data.get("name"), "Русский язык")
