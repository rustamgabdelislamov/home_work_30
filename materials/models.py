...
class Course(models.Model):
    name = models.CharField(unique=True, max_length=150, verbose_name='Название курса', help_text='Введите название текста')
...
class Lesson(models.Model):
    name = models.CharField(unique=True, max_length=150, verbose_name='Название урока',
